...
class Yolo:
    ...
    It contains the following functions:
        --load_pretrained_weights: which loads the pre-trained weights from h5 file.
        --make_coded_prediction: which makes coded predictions using pre-trained YOLOv2 model.
    """
